...
# Function to compute BERT embeddings for each sentence
...
def summ_1(text,
    ...
    # Use BERT embeddings instead of TF-IDF + LSA
    sentence_embeddings = get_bert_embeddings(sentences)

    # Calculate sentence importance using cosine similarity with BERT embeddings
