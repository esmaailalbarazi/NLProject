...
def summarization(text,
    ...
    return summary, rank_df, rouge_scores, (final_time - start_time)
...
if __name__ == "__main__":
    ...
    for add_kg, counting in itertools.product(add_kg_info_options.values(), counting_options.values()):
        ...
        summary, rank_df, rouge_scores, t = summarization(text, num_sentences, percentage_txt, counting, add_kg)
        ...
        final_results.append({
            ...
            "Counting": counting,
            "Summary": summary,
            # "Ranking DataFrame": rank_df.to_string(index=False),
            "ROUGE Scores": rouge_scores,
            "Time Taken": round(t, 2)
        })
    ...
    final_df.to_excel("final_summary_results.xlsx", index=False)
    print("Results saved to 'final_summary_results.xlsx'!")
